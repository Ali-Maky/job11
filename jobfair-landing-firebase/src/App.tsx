...
// *** NOTE: Changed type of tags, responsibilities, requirements to allow string for form input ***
type NewJobInput = {
  id?: string;
  title?: string;
  company?: string;
...
/** ----------------- Helpers ----------------- */
// *** NOTE: Renamed type to NewJobInput to match definition ***
...
export default function App() {
  const [jobs, setJobs] = React.useState<Job[]>(() => {
    try {
      ...
      // *** MODIFICATION: Added .map(normalizeJob) to fix build errors from invalid cached data ***
  ...
  // *** UI NOTE: This is your exact UI from the file. No changes here. ***
  return (
...
function AddVacancyModal({
  ...
  onClose: () => void;
  // *** MODIFICATION: Changed type to NewJobInput ***
...
function JobModal({
  ...
  // *** MODIFICATION: Replaced entire handleSubmit with Firebase logic ***
      ...
      <div className="relative z-10 w-full max-w-3xl rounded-t-3xl bg-white p-6 shadow-xl md:rounded-3xl h-[90vh] md:h-auto max-h-[90vh] md:max-h-[85vh] overflow-y-auto overscroll-contain">
        ...
        <div className="mt-6 grid gap-8 md:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl border border-gray-200 p-4 pb-24">
            ...
            {/* *** MODIFICATION: Updated description to Firebase *** */}
            ...
            <input
              ...
              // *** MODIFICATION: Added disabled state ***
              disabled={loading}
            />
            ...
            <button
              ...
              // *** MODIFICATION: Added disabled state and loading text ***
              disabled={loading || ok}
            >
